...
import org.eclipse.tractusx.edc.iam.iatp.identity.DidIatpIdentityExtractor;
...
public class IatpIdentityExtension implements ServiceExtension {
    ...
    static final String NAME = "Tractusx DID IATP identity extension";
    private final DidIatpIdentityExtractor iatpIdentityExtractor = new DidIatpIdentityExtractor();
